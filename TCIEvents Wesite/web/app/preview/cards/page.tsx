...
export default function CardsPreviewPage() {
  ...
  return (
    <main className="container-page py-12">
      ...
      <p className="text-sm font-medium uppercase tracking-widest text-gold-500">
        Step 1.5 · Component preview
      </p>
      <h1 className="mt-3 flex items-center gap-2 text-4xl font-semibold text-ocean-900 md:text-5xl">
        FeaturedEventCard
      </h1>
